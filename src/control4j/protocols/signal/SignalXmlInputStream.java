...
implements control4j.protocols.tcp.IInputStream<Message>
{
  ...
  protected Request readRequest(Request request)
  {
  ...
  protected DataMessage readDataMessage(DataMessage data) 
  ...
  protected void readSignal(DataMessage data)
  throws XMLStreamException
  {
    try
    {
